...
!function() {
                ...
                i = function(n, r) {
                    ...
                    if (r)
                        for (var a, l = function(e) {
                            ...
                            }(n), i = 0, c = y.length; i < c; i++) l.call(n, a = y[i]) && (t.has(n) || t.set(n, new f), (o = t.get(n)).has(a) || (o.add(a), e.handle(n, r, a)));
    ...
    if (k) {
        ...
        self.customElements = {
            define: function(e, t) {
                ...
                $.set(t, e), j.set(e, t.prototype), R.set(e, t), V.push(e), B(e).then((function() {
            ...
            value: x
        }), self.HTMLElement = x, g.createElement = function(e, t) {
            var n = t && t.is,
                r = n ? R.get(n) : R.get(e);
    ...
    } else if (k = !self.customElements.get("extends-br")) try {
        var z = function e() {
            return self.Reflect.construct(HTMLBRElement, [], e)
        };
        z.prototype = HTMLLIElement.prototype;
        var G = "extends-br";
        self.customElements.define("extends-br", z, {
            extends: "br"
